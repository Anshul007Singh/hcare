    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.text}>
          Plot no 344, Industrial Area, Phase 2, HSIIDC, Alipur, Barwala, Panchkula, Haryana 134118
        </Text>
      </View>
      ...
      {/* Website Section */}
      <View style={styles.row}>
        <Ionicons name="link-outline" size={24} color="white" style={styles.icon} />
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'rgba(171, 127, 233, 0.89)', // Green background
    padding: 20,
    justifyContent: 'center',
    borderRadius: 10,
    marginTop:20 // Rounded edges for aesthetics
  },
  title: {
    fontSize: 24,
    fontWeight: 'bold',
